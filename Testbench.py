...
rdt_receiver.N=16 # Window size for the receiver (Note: This is ignored in the GBN protocol, but required in the SR protocol)
...
TOTAL_SIMULATION_TIME=40  # <==== Total simulation time. Increase it as you like.
t=0
while True:
	if(env.peek()>t):
		rdt_sender.print_status()
